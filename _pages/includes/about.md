...
<span class="icon-inline">{% include icon.html name="file" %}</span> Download my <a href="#" class="show-notice-link" data-target="CV">curriculum vitae</a> (temporarily unavailable).
