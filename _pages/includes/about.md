...
<p><svg {% include icon.html name="file" %}><path d="{{ site.data.icons['file'].d }}">/></svg> Download my <a href="#" class="show-notice-link" data-target="CV">curriculum vitae</a> (temporarily unavailable).</p>
